<nav class="navbar navbar-light bg-light navbar-top">
    <div class="container-fluid">
        ...
        <div class="col-md-0">
            <a href="/login" class="text-dark text-decoration-none" target="_blank"><span
    ...
    <div class="collapse navbar-collapse" id="navbarsExample07XL">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown" style="bottom: -5px">
                <a class="nav-link nav-text dropdown-toggle {{ $active === 'profile' ? 'active' : '' }}"
                    href="/profile" id="dropdown07XL" data-bs-toggle="dropdown" aria-expanded="false">Profil</a>
                <ul class="dropdown-menu" aria-labelledby="dropdown07XL">
                    <li><a class="dropdown-item {{ $active === 'profile' ? 'active' : '' }}" href="/profile">Sejarah FRPB</a></li>
                    <li><a class="dropdown-item {{ $active === 'profile' ? 'active' : '' }}" href="/profile">Visi & Misi</a></li>
                    <li><a class="dropdown-item {{ $active === 'profile' ? 'active' : '' }}" href="/profile">Struktur Organisasi</a></li>
                </ul>
            </li>
            <li class="nav-item">
