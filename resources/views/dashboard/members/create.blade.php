...
@section('content-wrapper')
    ...
    <section class="content">
        <div class="col-lg-8">
            <form method="post" action="/dashboard/members" enctype="multipart/form-data" class="mb-5">
                @csrf
                ...
                <div class="form-group">
                    <label for="date_birth" class="form-label">Tgl Lahir</label>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('gender') is-invalid @enderror" id="gender" name="gender"
                        ...
                        @foreach ($statusOptions as $option)
                            <option value="{{ $option }}" @if (old('gender') == $option) selected @endif>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('marital_status') is-invalid @enderror" id="marital_status"
                        ...
                        @foreach ($statusOptions as $option)
                            <option value="{{ $option }}" @if (old('marital_status') == $option) selected @endif>
                                {{ ucwords($option) }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    <label for="date_joined" class="form-label">Tgl Gabung</label>
                    <input type="date" class="form-control @error('date_joined') is-invalid @enderror"
                        id="date_joined" name="date_joined" required value="{{ old('date_joined') }}">
                    @error('date_joined')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <button type="submit" class="btn btn-primary">Buat Anggota</button>
            </form>
        </div>
    </section>
    <script>
