                      ...
                      <tbody>
                          @foreach ($galleries as $gallery)
                              <tr>
                                  ...
                                  <td>
                                      <a href="/dashboard/galleries/{{ $gallery->slug }}" class="btn btn-info btn-sm">Detail</a>
                                      <a href="/dashboard/galleries/{{ $gallery->slug }}/edit" class="btn btn-warning btn-sm">Edit</a>
