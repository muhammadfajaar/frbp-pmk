    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                <h5 class="card-title"><a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none"
                        style="color: #00ADB5">{{ $posts[0]->title }}</a></h5>
                <p>
                ...
                <a href="/posts/{{ $posts[0]->slug }}" type="button" class="text-decoration-none btn btn-primary"
                    style="background-color: #00ADB5">Read more..</a>
